def index():
    ...
    db.object_collection.insert(object_id=4, collection_id=2)
    ...
    db.object_collection.insert(object_id=5, collection_id=2)
    ...
    db.object_collection.insert(object_id=6, collection_id=2)
    ...
    db.object_collection.insert(object_id=7, collection_id=3)
    ...
    db.object_collection.insert(object_id=10, collection_id=2)
