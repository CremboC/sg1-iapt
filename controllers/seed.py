def index():
    ...
    db.collections.insert(owner_id=1, name="old clothes", private=True) #3
    db.collections.insert(owner_id=1, name="media", private=False) #4
    ...
    db.object_collection.insert(object_id=1, collection_id=3)
    ...
    db.object_collection.insert(object_id=2, collection_id=3)
    ...
    db.object_collection.insert(object_id=3, collection_id=3)

    db.objects.insert(owner_id=1, type_id=8, status=2, name='Friends blu ray box set', currency_value=30.0, summary='10 friends blu ray discs',
    ...
    db.objects.insert(owner_id=1, type_id=8, status=2, name='Star wars: a new hope dvd', currency_value=10.0, summary='dvd of a new hope',
    ...
    db.object_collection.insert(object_id=5, collection_id=4)

    db.objects.insert(owner_id=1, type_id=8, status=2, name='Toy story dvd', currency_value=5.0, summary='dvd of the first toy story film',
    ...
    db.object_collection.insert(object_id=6, collection_id=4)
    ...
    db.object_collection.insert(object_id=7, collection_id=1)
    ...
    db.object_collection.insert(object_id=8, collection_id=1)
    ...
    db.object_collection.insert(object_id=9, collection_id=3)
    ...
    db.object_collection.insert(object_id=10, collection_id=3)
